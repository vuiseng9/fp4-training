"""
based on 
https://github.com/triton-lang/triton/blob/main/python/tutorials/10-block-scaled-matmul.py
commit id : 05a0439 (main)
...
def block_scaled_matmul(a_desc, a_scale_desc, b_desc, b_scale_desc, dtype_dst, M, N, K, rep_m, rep_n, rep_k, configs):
    ...
    output = torch.empty_strided(
                (M, N), stride=(16, 1), dtype=dtype_dst, device="cuda")
