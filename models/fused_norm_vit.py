...
from .transformer_block import TransformerBlock, FusedNormTransformerBlock
import warnings

class FusedNormTinyViT(nn.Module):
    """
    ...
    def __init__(
        ...
        num_heads=4,
        mlp_ratio=2.0,
        norm_impl="LayerNorm",  # "LayerNorm", "RMSNorm"
    ):
        super().__init__()
        ...
        self.encoder = FusedNormTransformerBlock(
            E=embed_dim,
